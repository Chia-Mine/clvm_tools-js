...
- [`clvm@4.1.0`](https://github.com/Chia-Mine/clvm-js/tree/v4.1.0) of [clvm-js](https://github.com/Chia-Mine/clvm-js), whose bundled `clvm_wasm` provides the Rust (`clvm_rs`) execution backend
