...
function RunProgram() {
    ...
    const f = function (program, args, option) {
        const option2 = option ? Object.assign(Object.assign({}, option), { operator_lookup: f.operator_lookup }) : { operator_lookup: f.operator_lookup };
        return stage_0_1.run_program(program, args, option2);
    };
